...
I'm an IT professional focused on **Cloud infrastructure**, currently working at [Altostratus Cloud Consulting](https://altostratus.es) designing and deploying scalable, secure environments on Google Cloud Platform. I'm passionate about automation, Infrastructure as Code, and building robust architectures — from design to production.

Lately, I'm increasingly interested in **Artificial Intelligence**: both leveraging AI tools in my day-to-day work and architecting the infrastructure required to train and serve ML models at scale (GPUs, distributed storage, MLOps pipelines).
...
| Certification | Year |
|---|---|
| GCP Professional Database Engineer | 2025 |
...
### Earlier roles
- **System Technician** — Cimkey *(2017)*
- **Helpdesk** — Keapps-Serunion *(2016)*
- **Junior Systems Technician** — Eskpe Consulting *(2014–2015)*
- **Junior System Technician** — Covidien Spain *(2012–2013)*

---

## 🎓 Education

- **Higher Degree — Computer Systems and Networks Administration**  
  Sant Adrià del Besós, 2013–2015
- **Middle Degree — Computer Systems Exploitation**  
  Barcelona, 2008–2010
